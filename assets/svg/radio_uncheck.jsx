...
const RadioUncheck = `<?xml version="1.0" encoding="utf-8"?><!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
...
export default () => <SvgXml xml={RadioUncheck} width="32" height="32" />